...
Equations.prototype.solve = function solve() {
  ...
  const attemptToSolveEquation = (equation) => {
    // TODO
    var value;
    ...
    // TODO: remove the equation so we don't evaulate it again
    // equations = equations.delete(index);
    // expect then the indexes get off and we start removing different equations
    return true;
  };
